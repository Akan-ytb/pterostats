...
module.exports = async function getStats(client) {
    try {
        ...
        if (data.isPanelDown) webhook(
            new EmbedBuilder()
                .setTitle("Panel En Ligne")
                .setColor("57F287")
                .setDescription(`Le panel est actuellement fonctionnel`)
        )
            ...
            try {
                ...
                if (results.uptime) webhook(
                    new EmbedBuilder()
                        ...
                        .setColor("ED4245")
                        .setDescription(`Le panel est actuellement hors`)
                );
